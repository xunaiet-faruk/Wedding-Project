        ...
        <div>
                ...
                <div className="carousel w-full " data-aos="zoom-out-right" data-aos-duration="1000">
                    <div id="slide1" className="carousel-item relative w-full flex gap-32 justify-center mt-12 items-center">
                       ...
                       <div className='bg-gray-100 shadow-2xl mb-20  p-8 rounded-md'>
                    ...
                    <div id="slide2" className="carousel-item relative w-full flex gap-32 justify-center items-center">
                    ...
                    <div id="slide3" className="carousel-item relative w-full flex gap-32 justify-center items-center">
