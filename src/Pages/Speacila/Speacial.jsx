...
const Speacial = () => {
    return (
        <div>
            <div className='' data-aos="flip-left" data-aos-duration="1500">
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-1 gap-12 p-10  max-w-7xl mx-auto'>
                ...
                <div className="hero min-h-screen  w-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/d5GBMjK/crr1.jpg)' }}>
                ...
                <div className='' data-aos="fade-left"
                    ...
                    data-aos-offset="500"
                    data-aos-duration="500">
                <div className="hero min-h-screen w-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/Jkg3q80/be1.jpg)' }}>
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                ...
                <div className='' data-aos="fade-right"
                    ...
                    data-aos-offset="500"
                    data-aos-duration="500">
                <div className="hero min-h-screen w-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/ZdB8yYD/cp2.jpg)' }}>
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                ...
                <div className='' data-aos="fade-left"
                    ...
                    data-aos-offset="500"
                    data-aos-duration="500">
                <div className="hero min-h-screen w-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/VwTd8Pj/ki.jpg)' }}>
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                ...
                <h1 className='text-center text-2xl font-bold italic'>Bokking</h1>
