            ...
            <div className="carousel w-full h-[700px]">
                <div id="slide1" className="carousel-item   bg-black relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div>
                            <p className="text-white text-transparent bg-clip-text bg-gradient-to-b from-green-500 to-purple-500 italic font-bold text-7xl">Welcome To our weeding Webside</p>
                           <p className="text-center italic font-bold text-4xl text-white "> This is best webside for Weeeding partys</p>
                        </div>
