    ...
    return (
        <div className=" lg:h-[600px] bg-pink-50" >
            ...
            <div className="flex justify-around flex-col md:flex-row max-w-7xl mx-auto">
                <div className="lg:mt-48 md:mt-40 mt-20 md:ml-4 text-center ">
                ...
                <div className="">
                    ...
                    <img className="lg:w-[1300px] md:ml-2 -ml-20 md:w-[900px] mt-10" src={'https://www.matrimony.com/sites/default/files/2023-03/hero-banner-2.png'} alt="" />
